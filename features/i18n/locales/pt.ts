...
export const ptBundle: LocaleBundle = {
  ...
  messages: {
    ...
    refund_intro:
      'Reembolsos são processados pela Paddle (nosso merchant of record). Você pode solicitar reembolso dentro de 14 dias após a compra.',
    refund_no_refunds_title: 'Prazo de reembolso',
    refund_no_refunds_item1: 'A solicitação deve ser enviada dentro de 14 dias após a compra.',
    refund_no_refunds_item2: 'Reembolsos são processados pela Paddle.',
    refund_no_refunds_item3: 'Inclua seu ID de transação da Paddle ao enviar a solicitação.',
    refund_issue_title: 'Precisa de ajuda?',
    refund_issue_item1: 'Se você tiver um problema de acesso ou entrega, entre em contato com o suporte da Paddle.',
    refund_issue_item2: 'A Paddle pode solicitar seu ID de transação e detalhes da compra.',
    refund_issue_item3: 'Se a Paddle solicitar informações adicionais sobre o produto, você também pode nos escrever em: spinnermining@gmail.com.',
