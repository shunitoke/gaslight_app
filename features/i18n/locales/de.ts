...
export const deBundle: LocaleBundle = {
  ...
  messages: {
    ...
    refund_intro:
      'Rückerstattungen werden von Paddle (unserem Merchant of Record) bearbeitet. Du kannst innerhalb von 14 Tagen nach dem Kauf eine Rückerstattung anfordern.',
    refund_no_refunds_title: 'Rückerstattungsfrist',
    refund_no_refunds_item1: 'Der Antrag muss innerhalb von 14 Tagen nach dem Kauf gestellt werden.',
    refund_no_refunds_item2: 'Rückerstattungen werden von Paddle verarbeitet.',
    refund_no_refunds_item3: 'Bitte gib bei der Anfrage deine Paddle-Transaktions-ID an.',
    refund_issue_title: 'Brauchst du Hilfe?',
    refund_issue_item1: 'Wenn es ein Problem mit Zugriff oder Lieferung gibt, wende dich bitte an den Paddle-Support.',
    refund_issue_item2: 'Paddle kann nach deiner Transaktions-ID und Kaufdetails fragen.',
    refund_issue_item3: 'Wenn Paddle zusätzliche Informationen zum Produkt benötigt, erreichst du uns auch unter spinnermining@gmail.com.',
