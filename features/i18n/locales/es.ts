...
export const esBundle: LocaleBundle = {
  ...
  messages: {
    ...
    uploadExport: 'Subir conversación',
    uploadExportDescription: 'Analizamos conversaciones de muchos años.',
    confirmImportPrompt:
    ...
    progress_finalizing_hint:
      'Estamos uniendo secciones y gráficos. Este último paso puede tardar hasta un minuto — gracias por esperar.',
    ...
    premium_progress_hint:
      'Análisis detallado en curso: procesamos texto y los medios disponibles.',
    free_progress_hint:
      'Análisis básico: solo texto por ahora; medios llegarán más adelante.',
    progress_premium_features_profiles: 'Ideas sobre los participantes a partir de los mensajes',
    ...
    terms_operator_title: 'Operador y nombre legal',
    terms_operator_content:
      'Nombre legal: Texts with My Ex. Email de contacto: spinnermining@gmail.com.',
    ...
    refund_intro:
      'Puedes solicitar un reembolso dentro de los 14 días posteriores a la compra. Para solicitarlo, escríbenos e incluye tu ID de transacción de Paddle.',
    ...
    refund_contact_text_suffix: 'con tu ID de transacción de Paddle y tu solicitud de reembolso. Respondemos lo antes posible.',
    ...
    pricing_premium_label: 'Paquete de 5 informes (cualquier tamaño)',
    pricing_price_unit: 'pago único',
    pricing_premium_description:
      'Incluye 5 informes completos en este dispositivo. Sin suscripción. Sin cobros recurrentes.',
    ...
    pricing_premium_item4: '5 informes completos incluidos',
    pricing_premium_cta: 'Comprar 5 informes',
    pricing_any_chat_size_badge: 'Cualquier tamaño de chat',
    pricing_media_label: 'Paquete con media (próxima versión)',
    pricing_media_badge: 'Próximamente',
    pricing_media_description:
      'Planificado: analizar fotos/notas de voz y desbloquear 10 informes. Aún no disponible.',
    pricing_media_item1: '10 informes completos incluidos',
    pricing_media_item2: 'Análisis de media (imágenes/audio) en el informe',
    pricing_media_item3: 'Ideal para exportaciones de Telegram con fotos y audios',
    pricing_media_item4: 'Acceso temprano en cuanto salga la actualización',
    pricing_media_cta: 'Disponible en la próxima versión',
    pricing_media_note:
      'Este plan todavía no se puede comprar. Activaremos el pago después de lanzar la actualización de media.',
    ...
    pricing_what_onetime_title: 'Pago único',
    pricing_what_onetime_text:
      'Sin suscripción. Tu compra desbloquea un paquete de informes completos en este dispositivo.',
