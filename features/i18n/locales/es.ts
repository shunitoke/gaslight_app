...
export const esBundle: LocaleBundle = {
  ...
  messages: {
    ...
    refund_intro:
      'Los reembolsos los gestiona Paddle (nuestro merchant of record). Puedes solicitar un reembolso dentro de los 14 días posteriores a la compra.',
    refund_no_refunds_title: 'Plazo de reembolso',
    refund_no_refunds_item1: 'La solicitud debe enviarse dentro de los 14 días posteriores a la compra.',
    refund_no_refunds_item2: 'Los reembolsos los procesa Paddle.',
    refund_no_refunds_item3: 'Incluye tu ID de transacción de Paddle al enviar la solicitud.',
    refund_issue_title: '¿Necesitas ayuda?',
    refund_issue_item1: 'Si tienes un problema de acceso o entrega, contacta con el soporte de Paddle.',
    refund_issue_item2: 'Paddle puede pedir tu ID de transacción y los detalles de la compra.',
    refund_issue_item3: 'Si Paddle solicita información adicional sobre el producto, también puedes escribirnos a: spinnermining@gmail.com.',
    refund_contact_title: 'Cómo solicitar un reembolso',
    refund_contact_text_prefix: 'Envía tu solicitud de reembolso a través de',
    refund_contact_text_suffix: 'e incluye tu ID de transacción de Paddle.',
