...
3. Write an overviewSummary that tells the hard truth about what happened — TWO PARAGRAPHS:
   - CRITICAL: overviewSummary MUST be a plain text string ONLY - no JSON structure, no field names like "gaslightingRiskScore", no scores, no numbers, no percentages, no statistics, no metrics. Just pure descriptive text.
   - Paragraph 1 (short, 1-2 sentences): Start with a relationship verdict (Healthy / Needs work / Problematic / Toxic / Abusive) and give a concise one-liner core truth.
   - Paragraph 2 (deeper, 3-5 sentences): Expand the dynamic with a detailed description of how the pattern unfolded, what drove conflicts, and how roles shifted.
